const { Client, Collection, Partials, GatewayIntentBits, ActionRowBuilder, ButtonBuilder, ButtonStyle, Events, EmbedBuilder, ActivityType, StringSelectMenuBuilder,StringSelectBuilder } = require('discord.js');
const client7 = require("../index");
...
const distube = new DisTube(client7, {
